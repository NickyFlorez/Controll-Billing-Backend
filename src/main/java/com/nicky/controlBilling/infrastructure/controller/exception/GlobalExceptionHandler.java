...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> passwordDontMatchExceptionHandler(PasswordDontMatchException exception){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(exception.getMessage());
    }

    @ExceptionHandler(SignatureVerificationException.class)
    public ResponseEntity<String> signatureVerificationExceptionHandler(SignatureVerificationException exception){
